...
import static com.example.test.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.example.test.PojaApplication;
import com.example.test.PojaGenerated;
import com.example.test.endpoint.EndpointConf;
import com.example.test.endpoint.event.EventConf;
import com.example.test.endpoint.event.consumer.EventConsumer;
