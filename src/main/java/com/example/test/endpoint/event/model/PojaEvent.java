package com.example.test.endpoint.event.model;

import static com.example.test.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.example.test.PojaGenerated;
import com.example.test.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.example.test.event1";
    return "com.example.test.event2";
  }
}
