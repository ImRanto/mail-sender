package com.example.test.endpoint.rest.controller.health;

import static com.example.test.file.hash.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import com.example.test.PojaGenerated;
import com.example.test.file.bucket.BucketComponent;
import com.example.test.file.hash.FileHash;
import java.io.File;
